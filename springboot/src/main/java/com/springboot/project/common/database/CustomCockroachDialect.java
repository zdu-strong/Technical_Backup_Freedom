...
public class CustomCockroachDialect extends CockroachDialect {
    ...
    public void initializeFunctionRegistry(FunctionContributions functionContributions) {
        ...
        functionRegistry.registerPattern("LOCATE", "POSITION(?2, ?1)",
                basicTypeRegistry.resolve(StandardBasicTypes.LONG));
    ...
    public CustomCockroachDialect() {
        super();
    }

    public CustomCockroachDialect(DialectResolutionInfo info) {
        super(info);
    }

    public CustomCockroachDialect(DatabaseVersion version) {
        super(version);
    }

    public CustomCockroachDialect(DatabaseVersion version, PostgreSQLDriverKind driverKind) {
